  ...
  handleOnScroll(sticky_menu_trigger_px) {
    ...
    if (ELE_TOP_MENU_BODY != null) {
      if (window.pageYOffset > sticky_menu_trigger_px) {
        ...
        ELE_TOP_MENU_BODY.style.background =
          "linear-gradient(180deg, rgba(39,60,117,1) 0%, rgba(39,60,117,1) 60%, rgba(39,60,117,0) 100%)";
    ...
    return (
      <div style={style.greeting_container}>
        <div style={style.hello_greeting}>
          <img
            src={avatar}
            style={style.nav_top_avatar_img}
            alt="avatar image"
          />
          <div style={style.hello_text}>Hi, I am louis</div>
        </div>
