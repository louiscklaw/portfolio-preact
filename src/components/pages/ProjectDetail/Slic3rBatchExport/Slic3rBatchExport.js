      ...
      <div className={projectDetailStyle.Container}>
        ...
        <div className={projectDetailStyle.ProjectDescription}>
          <div className={projectDetailStyle.ProjectHead}>
            <BackToProjects />
            <ProjectTitle project_title="Slic3r Dashboard" />
            <Spare />
          </div>

          <HeaderFigure img_src={head_pic} caption="Slic3r Dashboard" />

          <div className={projectDetailStyle.DescBody}>
            <h3 className={projectDetailStyle.DescTopic}>What is it ?</h3>
            <p>An easy tool to export gcode from slic3r.</p>

            <h3 className={projectDetailStyle.DescTopic}>background:</h3>
            <p>
              The option of slic3r command linx options wasn’t availabe under
              linux as described. The tools written to help perorming export 3mf
              -> save to stl -> export gcode as a batch operation.
            </p>

            <h3 className={projectDetailStyle.DescTopic}>How to use:</h3>
            <ul>
              <li>Clone repo:</li>
            ...
            <h3 className={projectDetailStyle.DescTopic}>How it works:</h3>
            <YoutubeContainer vid="YNCB23V38x0" video_title="passing example" />

            <h3 className={projectDetailStyle.DescTopic}>Repoistory:</h3>
...
export { Slic3rContent, Slic3rThumbnail };
