      ...
      <div className={projectDetailStyle.Container}>
        ...
        <div className={projectDetailStyle.ProjectDescription}>
          <div className={projectDetailStyle.ProjectHead}>
            <BackToProjects />
            <ProjectTitle project_title="rthk31-rthk32 linux viewer" />
            <Spare />
          </div>
          ...
          <div className={projectDetailStyle.DescBody}>
            ...
            <p>
              To connect to the world while you’re working in linux environment
              at home…… inspired by
              <NewWindowLink
                link="https://blog.wtako.net/view/23"
                text="Linux桌面環境下收看ViuTV"
              />
            </p>
            ...
            <ul>
              <il>
                open ~/.bashrc or ~/.zshrc and paste the following source into
                it
              </il>
...
export { RTHK31Content, RTHK31Thumbnail };
