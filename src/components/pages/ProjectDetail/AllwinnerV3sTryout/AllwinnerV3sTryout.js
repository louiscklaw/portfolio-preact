      ...
      <div className={projectDetailStyle.Container}>
        ...
        <div className={projectDetailStyle.ProjectDescription}>
          ...
          <div className={projectDetailStyle.DescBody}>
            ...
            <p>
              This is a tryout of homemake embedded linux project using
              allwinner v3s chips inspired by
              <NewWindowLink link="https://www.reddit.com/r/electronics/comments/83141t/i_made_an_allwinner_v3s_evaluation_board_based/" />
            </p>

            <h3 className={projectDetailStyle.DescTopic}>progress:</h3>
            <p>
            ...
            <h3 className={projectDetailStyle.DescTopic}>Buildroot:</h3>
            <ul>
              <li>to setup ubuntu/docker for buildroot(tested under 18.04)</li>
              <li>
                sudo apt-get install iputils-ping vim git wget xz-utils bzip2
                gcc device-tree-compiler python python-dev time make pkg-config
              </li>
            </ul>
            ...
            <h3 className={projectDetailStyle.DescTopic}>BOM/Part list:</h3>
            <p>To be updated</p>
          </div>
        </div>
      </div>
...
export { AllwinnerContent, AllWinnerThumbnail };
