    ...
    return (
      <div style={style_js.main}>
        <div style={style_js.nav_container}>
          {styles.showSidebar ? <SideMenu style={styles} /> : <TopBar />}
        </div>

        <div style={style_js.content}>
          <Router onChange={onRouteChangeHelloworld}>
            <AsyncRoute
              path="/project_catalogue"
              component={PageProjectCatalogue}
            />

            <AsyncRoute
              path="/project_detail/:project_to_show"
